...
#if !(defined(CONFIG_TARGET_MX7DEA_COM) || defined(CONFIG_TARGET_MX7DEA_UCOM) || defined(CONFIG_TARGET_MX6QEA_COM) || defined(CONFIG_TARGET_MX6DLEA_COM) || defined(CONFIG_TARGET_MX6SXEA_COM))
struct _ea_ddr_cfg
{
	u32 addr;
	u32 val;
